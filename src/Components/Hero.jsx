  ...
  return (
    <div className='bg-linear-to-r ml-[5vw] relative h-[40vw] from-[#3A99C9] to-[#0073AE]'>
      ...
      <div>
        ...
        <h5 style={{ fontFamily: 'Calibri, sans-serif' }} className='absolute top-[32%] left-[29.5%] translate-[-50%] text-[1.5vw] font-[500] text-white w-[11vw] text-center'>
      ...
      <div>
        ...
        <h5 style={{ fontFamily: 'Calibri, sans-serif' }} className='absolute top-[34%] right-[16%] translate-[-50%] text-[1.5vw] font-[500] text-white w-[11vw] text-center'>
      ...
      <div>
        ...
        <h5 style={{ fontFamily: 'Calibri, sans-serif' }} className='absolute bottom-[8%] left-[34.5%] translate-[-50%] text-[1.3vw] font-[500] text-white w-[8vw] text-center'>
      ...
      <div>
        ...
        <h5 style={{ fontFamily: 'Calibri, sans-serif' }} className='absolute bottom-[14%] right-[24.5%] translate-[-50%] text-[1.5vw] font-[500] text-white w-[8vw] text-center'>
          Team Solutions
        </h5>
      </div>
